...
SECTOR_STOCKS = {
    "IT": [
        ...
        "HEXAWARE","NEWGEN","CYIENT","BIRLASOFT","ECLERX",
    ],
    "BANK": [
    ...
    "AUTO": [
        ...
        "MRF","MOTHERSON","BOSCHLTD","BHARATFORG","EXIDEIND","SUNDRMFAST",
    ],
    "FMCG": [
    ...
    "DEFENCE": [
        "HAL","BEL","BEML","BHEL","MAZAGON","GRSE","COCHINSHIP",
        "ASTRA","PARAS","MTAR","CENTUM","SOLARIND","DYNAMATECH",
    ],
    "TEXTILE": [
