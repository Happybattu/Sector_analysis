...
SECTOR_STOCKS = {
    ...
    "CHEMICAL": [
        "ZFSTEERING", "ZFCVINDIA", "WHEELS", "VIAZ", "VELJAN", "VARROC", "UWCSL", "URAVIDEF", "UNOMINDA", "UNIPARTS", "UCAL", "TVSSRICHAK",
        "TOLINS", "TIINDIA", "TENNIND", "TCL", "TALBROAUTO", "SUPRAJIT", "SUNDRMFAST", "SUNDRMBRAK", "SUNCLAY", "STUDDS", "STERTOOLS",
        "SSWL", "SONACOMS", "SJS", "SINTERCOM", "SHRIPISTON", "SHIVAMAUTO", "SHIGAN", "SHARDAMOTR", "SETCO", "SELLOWRAP",
        "SEDEMAC", "SCHAEFFLER", "SANSERA", "SANDHAR", "ROLEXRINGS", "RML", "RKFORGE", "RICOAUTO", "REMSONSIND", "RAJRATAN",
        "RACLGEAR", "PRITIKAUTO", "PRITIKA", "PRICOLLTD", "PREMIUM", "PRECISION", "PRECAM", "PRADPME", "PPAP", "PAVNAIND",
        "OMAXAUTO", "OBSCP", "NRBBEARING", "NDRAUTO", "MUNJALSHOW", "MUNJALAU", "MSUMI", "MRF", "MOTHERSON", "MODIRUBBER",
        "MMFL", "MINDACORP", "MENONBE", "MENNPIS", "MAXVOLT", "MANDEEP", "LUMAXTECH", "LUMAXIND", "LGBBROSLTD", "LAKPRE",
        "KROSS", "JTEKTINDIA", "JMA", "JKTYRE", "JBMA", "JAYBARMARU", "JAMNAAUTO", "ITTL", "INDNIPPON", "IMPAL", "IGARASHI",
        "HITECHGEAR", "HINDCOMPOS", "GOODYEAR", "GOLDSTAR", "GNA", "GABRIEL", "FRONTSP", "FORGEAUTO", "FMGOETZE", "FIEMIND",
        "EXIDEIND", "ETML", "ENDURANCE", "DIVGIITTS", "CRAFTSMAN", "CIEINDIA", "CEATLTD", "CARRARO", "BOSCHLTD", "BIMETAL",
        "BHARATSE", "BHARATGEAR", "BHARATFORG", "BELRISE", "BANCOINDIA", "BALKRISIND", "AVATAR", "AUTOIND", "AUTOAXLES", "ASKAUTOLTD",
        "ASAL", "ASAHIINDIA", "ARE&M", "APOLLOTYRE", "ALICON",
    ],
    "CEMENT": [
