...
SECTOR_STOCKS = {
    "IT": [
        ...
        "SOFTTECH", "IRIS", "CYBERTECH", "XTGLOBAL", "ABMKNO","VGINFOTECH", "3IINFOLTD", "TREJHARA", "SYSTANGO", "ALLETEC",
        "GOLDTECH", "EMPOWER", "EQUIPPP", "FIDEL", "DRCSYSTEMS", "TECHLABS", "VIRINCHI", "TRIGYN", "SECMARK", "XELPMOC",
        "CANARYS", "GVPTECH", "RSSOFTWARE", "MOBILISE", "DELAPLEX", "CURAA", "TRUST", "PARAMATRIX", "ORCHASP", "CTE",
        "CALSOFT", "SATECH", "QUICKTOUCH", "YUDIZ", "MICROPRO", "QUINTEGRA",        
    ],
    "BANK": [
