...
SECTOR_STOCKS = {
    ...
    "BANK": [
        ...
        "CANBK", "INDIANB", "IDBI", "FEDERALBNK", "YESBANK", "AUBANK", "INDUSINDBK",
        "IDFCFIRSTB", "MAHABANK", "IOB", "BANKINDIA", "RBLBANK", "UCOBANK", "BANDHANBNK",
        "CENTRALBK", "KARURVYSYA", "CUB", "PSB", "J&KBANK", "SOUTHBANK", "TMB",
        "UJJIVANSFB", "KTKBANK", "EQUITASBNK", "DCBBANK", "CSBBANK", "JSFB",
        "UTKARSHBNK", "SURYODAY", "ESAFSFB", "CAPITALSFB", "DHANBANK", "FINOPB",
        "ZSARACOM", "WELINV", "VHL", "TVSHLTD", "THACKER", "SUNDARMFIN", "SUMMITSEC", "SHRIRAMFIN",
        "RANEHOLDIN", "PNBHOUSING", "PIRAMALFIN", "PILANIINVS", "NSIL", "NDGL", "NBIFIN", "MUTHOOTFIN",
        "MAHSCOOTER", "KICL", "KAMAHOLD", "JSWHL", "JPOLYINVST", "JINDALPHOT", "INDPRUD", "HOMEFIRST",
        "GKWLIMITED", "ELCIDIN", "CRISIL", "CREDITACC", "CHOLAHLDNG", "CHOLAFIN", "BENGALASM",
        "BAJAJHLDNG", "BAJAJFINSV", "ARMANFIN", "AKCAPIT", "AAVAS",
    ],
    "PHARMA": [
    ...
    "AUTO": [
        ...
        "MRF","MOTHERSON","BOSCHLTD","BHARATFORG","EXIDEIND","SUNDRMFAST","SONACOMS.NS" "ZFSTEERING", "ZFCVINDIA", "WHEELS", "VIAZ", "VELJAN", "VARROC",
        "UWCSL", "URAVIDEF", "UNOMINDA", "UNIPARTS", "UCAL", "TVSSRICHAK","TOLINS", "TIINDIA", "TENNIND", "TCL", "TALBROAUTO", "SUPRAJIT",
        "SUNDRMFAST", "SUNDRMBRAK", "SUNCLAY", "STUDDS", "STERTOOLS", "SSWL", "SONACOMS", "SJS", "SINTERCOM", "SHRIPISTON",
        "SHIVAMAUTO", "SHIGAN", "SHARDAMOTR", "SETCO", "SELLOWRAP", "SEDEMAC", "SCHAEFFLER", "SANSERA", "SANDHAR", "ROLEXRINGS",
        "RML", "RKFORGE", "RICOAUTO", "REMSONSIND", "RAJRATAN", "RACLGEAR", "PRITIKAUTO", "PRITIKA", "PRICOLLTD", "PREMIUM",
        "PRECISION", "PRECAM", "PRADPME", "PPAP", "PAVNAIND", "OMAXAUTO", "OBSCP", "NRBBEARING", "NDRAUTO", "MUNJALSHOW",
        "MUNJALAU", "MSUMI", "MRF", "MOTHERSON", "MODIRUBBER", "MMFL", "MINDACORP", "MENONBE", "MENNPIS", "MAXVOLT",
        "MANDEEP", "LUMAXTECH", "LUMAXIND", "LGBBROSLTD", "LAKPRE", "KROSS", "JTEKTINDIA", "JMA", "JKTYRE", "JBMA", "JAYBARMARU",
        "JAMNAAUTO", "ITTL", "INDNIPPON", "IMPAL", "IGARASHI", "HITECHGEAR", "HINDCOMPOS", "GOODYEAR", "GOLDSTAR", "GNA",
        "GABRIEL", "FRONTSP", "FORGEAUTO", "FMGOETZE", "FIEMIND", "EXIDEIND", "ETML", "ENDURANCE", "DIVGIITTS", "CRAFTSMAN",
        "CIEINDIA", "CEATLTD", "CARRARO", "BOSCHLTD", "BIMETAL", "BHARATSE", "BHARATGEAR", "BHARATFORG", "BELRISE", "BANCOINDIA",
        "BALKRISIND", "AVATAR", "AUTOIND", "AUTOAXLES", "ASKAUTOLTD", "ASAL", "ASAHIINDIA", "ARE&M", "APOLLOTYRE", "ALICON",            
    ],
    "FMCG": [
    ...
    "ENERGY": [
        "RELIANCE", "AEGISLOG", "ONGC", "NTPC", "GVT&D", "SUZLON", "POWERGRID", "POWERINDIA",
        "ADANIPOWER", "ADANIGREEN", "BHEL", "COALINDIA", "CGPOWER", "BPCL", "OIL", "TATAPOWER",
        "HPCL", "IOC", "ADANIENSOL", "SIEMENS", "GAIL", "ABB", "ENRIN", "ATGL",
        "JSWENERGY", "THERMAX", "NHPC", "PETRONET", "NLCINDIA", "IGL", "JPPOWER", "RPOWER",
        "INOXWIND", "TORNTPOWER", "CASTROLIND", "NTPCGREEN", "CESC", "MGL", "SJVN", "NAVA", "GUJGASLTD",
    ],
    "INFRA": [
    ...
    "CHEMICAL": [
        "YCCL", "YASHO", "VSCL", "VITAL", "VISHNU", "VINYLINDIA", "VINATIORGA", "VIKASECO", "VIDHIING", "VALIANTORG", "UNILEX",
        "UNIENTER", "ULTRAMAR", "UCL", "TRANSPEK", "TNPETRO", "TIRUMALCHM", "TECILCHEM", "TATVA", "TATACHEM", "SWANCORP",
        "SUDARSCHEM", "SUDARCOLOR", "STYRENIX", "STALLION", "SRHHYPOLTD", "SRF", "SRD", "SPLPETRO", "SPEB", "SOLARINDS",
        "SNEHAA", "SILKFLEX", "SHREEPUSHK", "SHK", "SEYAIND", "SAROJA", "SANGINITA", "SADHNANIQ", "SACHEEROME", "ROSSARI",
        "RNPL", "RITEZONE", "RAJPUTANA", "RAIN", "PROLIFE","PRIVISCL", "PRIMO", "PREMEXPLN", "PODDARMENT", "PLATIND",
        "PLASTIBLEN", "PIDILITIND", "PCBL", "PAUSHAKLTD", "PASUPTAC","PARAGON", "OCCLLTD", "OAL", "NOCIL", "NITTAGELA",
        "NEPTUNE", "NEOGEN", "NEOCHEM", "NAVINFLUOR", "MANORG", "MANALIPETC", "MAHICKRA", "LXCHEM", "LORDSCHLO",
        "LINDEINDIA", "KSHITIJPOL", "KRONOX", "KOTHARIPET", "KIRIINDUS", "KANCHI", "JUBLINGREA", "JUBLCPL", "JOCIL",
        "JGCHEM", "JAYAGROGN", "IVP", "ISHANCH", "IPHL", "INDOBORAX", "INDOAMIN", "IGPL", "IEML", "HSCL", "HPIL",
        "HPAL", "HINDCON", "GUJALKALI", "GRAUWEIL", "GOCLCORP", "GNFC", "GHCL", "GEMAROMA", "GALAXYSURF", "FOSECOIND",
        "FLUOROCHEM", "FINEORG", "FCL", "FAIRCHEMOR", "EXCELINDUS", "EPIGRAL", "ELLEN", "ELANTAS", "DYNPRO",
        "DUCOL", "DSFCL", "DMCC", "DICIND", "DIAMINESQ", "DHARIWAL", "DEEPAKNTR", "DEEPAKFERT", "DDEVPLSTIK",
        "DCW", "DAICHI", "CLEAN", "CHEMPLASTS", "CHEMFAB", "CHEMCON", "CHEMBONDCH", "CHEMBOND", "CAMLINFINE",
        "BODALCHEM", "BLACKROSE", "BIOPOL", "BHAGERIA", "BEPL", "BASF", "BALAMINES", "ATUL", "ASAHISONG", "ARVEE",
        "ARUNAYA", "ANURAS", "ANDHRSUGAR", "AMNPLST", "AMBANIORGO", "ALKYLAMINE", "ALKALI", "AKSHARCHEM",
        "AGARIND", "AETHER", "ACI", "AARTISURF", "AARTIIND", "ADVANCE", "AGROPHOS", "ANYA", "ARIES", "ARISTO",
        "ASTEC", "BALAJIPHOS", "BAYERCROP", "BESTAGRO", "BHAGCHEM", "BHARATRAS", "BOHRAIND", "CHAMBLFERT",
        "CLSL", "COROMANDEL", "DHANSA", "DHANUKA", "DHARMAJ", "FACT", "GSFC", "GSPCROP", "HERANBA", "IGCL",
        "INSECTICID", "IPL", "KHAICHEM", "KRISHANA", "MADRASFERT", "MBAPL", "MOL", "NACLIND", "NAGAFERT",
        "NFL", "NOVAAGRI", "PARADEEP", "PIIND", "PUNJABCHEM", "RALLIS", "RAMAPHO", "RCF", "SHARDACROP", "SHIVALIK",
        "SIKKO", "SPIC", "SUMICHEM", "UPL", "ZUARI",
    ],
    "CEMENT": [
    ...
    "DEFENCE": [
        "AEQUS", "APOLLO", "APSISAERO", "ASTRAMICRO.NS", "AVANTEL", "AXISCADES", "BDL", "BEL",
        "BEML", "BHEL", "BHARATFORG", "C2C", "CENTUM", "COCHINSHIP", "CYIENTDLM", "DATAPATTNS",
        "DCXINDIA", "DYNAMATECH", "GRSE", "HAL", "IDEAFORGE", "JAYKAY", "KRISHNADEF", "MAZDOCK.NS",
        "MIDHANI", "MTARTECH.NS", "NIBE", "PARAS", "ROSSTECH", "SIGMAADV", "SIKA", "SOLARINDS.NS",
        "TECHERA", "UNIMECH", "ZENTEC",
    ],
    "TEXTILE": [
    ...
    "OIL AND GAS": [
        "RELIANCE",	"BPCL",	"ATGL",	"HINDPETRO", "IOC",	"GAIL",	"ONGC",	"OIL",	
        "CHENNPETRO",	"AEGISLOG",	"PETRONET",	"IGL",	"MGL",	"CASTROLIND", "AEGISVOPAK",
    ],
    "EV": [
         "M&M", "RELIANCE", "MARUTI", "MOTHERSON", "ASHOKLEY", "HSCL", "MSUMI", "TMCV",
        "TVSMOTOR", "HEROMOTOCO", "TATACHEM", "TMPV", "EICHERMOT", "FORCEMOT", "BAJAJ-AUTO",
        "OLAELEC", "KEI", "CGPOWER", "BHARATFORG", "BOSCHLTD", "EXIDEIND", "SONACOMS",
        "ATHERENERG", "UNOMINDA", "TIINDIA", "HYUNDAI", "OLECTRA", "TATAELXSI", "KPITTECH",
        "ZFCVINDIA", "JWL", "MINDACORP", "TATATECH", "FLUOROCHEM", "JBMA", "ARE&M","SCHAEFFLER", "LTTS",
    ],
"NIFTY500": [
        "HDFCBANK","INDIGO","ICICIBANK","M&M","SBIN","RELIANCE","INFY","BHARTIARTL","MARUTI","LT","BAJFINANCE","HINDALCO","OFSS","MOTHERSON","AXISBANK","BSE","VEDL","TCS","ASHOKLEY","HSCL",
        "NATIONALUM","MSUMI","SHRIRAMFIN","BEL","TMCV","AEGISLOG","KAYNES","MCX","ONGC","TVSMOTOR","CHOLAFIN","NTPC","KOTAKBANK","HCLTECH","PINELABS","TATASTEEL","HEROMOTOCO","BANDHANBNK","NETWEB","MAXHEALTH",
        "GVT&D","TATACHEM","TMPV","ASIANPAINT","ETERNAL","CANBK","ADANIENT","EICHERMOT","DIXON","HFCL","MUTHOOTFIN","IDEA","SUZLON","SYRMA","GROWW","LODHA","POWERGRID","IRFC","ULTRACEMCO","TRENT",
        "POWERINDIA","COFORGE","MEESHO","NAUKRI","ADANIPOWER","HINDUNILVR","HINDZINC","POLYCAB","PFC","FORCEMOT","WIPRO","TECHM","ADANIGREEN","BHEL","BAJAJ-AUTO","SUNPHARMA","ADANIPORTS","JINDALSTEL","TATACONSUM","OLAELEC",
        "ITC","AUROPHARMA","APOLLOHOSP","HONASA","SWIGGY","TITAN","M&MFIN","HAL","DATAPATTNS","INDUSTOWER","TATACAP","KEI","COALINDIA","CGPOWER","KIRLOSENG","BANKBARODA","PAYTM","BPCL","IFCI","ZEEL",
        "BHARATFORG","NESTLEIND","PAGEIND","LICI","CUMMINSIND","JSWINFRA","WELCORP","OIL","BOSCHLTD","APARINDS","SAMMAANCAP","LTF","TATAPOWER","GMRAIRPORT","GRASIM","UNITDSPR","TEJASNET","DLF","INDHOTEL","MANAPPURAM",
        "CARTRADE","HINDPETRO","AUBANK","RRKABEL","RECLTD","MAZDOCK","DRREDDY","SBICARD","PIDILITIND","EXIDEIND","HDFCAMC","UNIONBANK","YESBANK","GODREJPROP","VBL","JSWSTEEL","JIOFIN","IOC","SONACOMS","FEDERALBNK",
        "LAURUSLABS","AMBER","BAJAJFINSV","SAIL","RVNL","NMDC","RBLBANK","PNB","ANANDRATHI","SUPREMEIND","PERSISTENT","ADANIENSOL","NYKAA","SOLARINDS","SIEMENS","HINDCOPPER","ATHERENERG","CDSL","CIPLA","UNOMINDA",
        "EMCURE","HBLENGINE","GAIL","INDIANB","GRSE","WOCKPHARMA","BDL","SBILIFE","ABB","WAAREEENER","DMART","ABCAPITAL","MARICO","PNBHOUSING","LENSKART","DIVISLAB","TIINDIA","ASTRAL","AADHARHFC","IIFL",
        "HYUNDAI","VMM","OBEROIRLTY","SCI","KPRMILL","GESHIP","ZENTEC","IDBI","COLPAL","INDUSINDBK","AMBUJACEM","RADICO","POLICYBZR","CAMS","PIIND","OLECTRA","DELHIVERY","GLAND","REDINGTON","ZYDUSLIFE",
        "PWL","ENRIN","PHOENIXLTD","ATGL","JSWENERGY","APLAPOLLO","COCHINSHIP","THERMAX","KALYANKJIL","ANGELONE","NHPC","PRESTIGE","MOTILALOFS","HAVELLS","POONAWALLA","IDFCFIRSTB","SRF","PATANJALI","NBCC","MFSL",
        "MAHABANK","CHOICEIN","LICHSGFIN","FORTIS","BRITANNIA","MANKIND","BANKINDIA","BELRISE","BIOCON","GODREJCP","BLUEJET","UPL","PREMIERENE","TATACOMM","TORNTPHARM","LTM","ICICIAMC","HDFCLIFE","NUVAMA","PPLPHARMA",
        "PETRONET","PCBL","AWL","GRAPHITE","TATAELXSI","CROMPTON","MPHASIS","SHREECEM","TARIL","JKTYRE","NAVINFLUOR","KPITTECH","TITAGARH","VOLTAS","ALKEM","NLCINDIA","APOLLOTYRE","NIACL","CUB","360ONE",
        "DABUR","ICICIGI","GLENMARK","LUPIN","VIJAYA","EMMVEE","HDBFS","CGCL","NATCOPHARM","JYOTICNC","IGL","ENGINERSIN","EMAMILTD","ACUTAAS","SAILIFE","LGEINDIA","IREDA","TRITURBINE","KFINTECH","ZFCVINDIA",
        "NAM-INDIA","ACMESOLAR","LEMONTREE","INDIACEM","CONCOR","DALBHARAT","GODFRYPHLP","JPPOWER","JWL","PGEL","ENDURANCE","NEULANDLAB","MRF","JSWCEMENT","HOMEFIRST","KAJARIACER","RPOWER","LLOYDSME","GABRIEL","ANANTRAJ",
        "COHANCE","PIRAMALFIN","HUDCO","INOXWIND","JINDALSAW","JAINREC","IEX","RAMCOCEM","BSOFT","NH","MINDACORP","JUBLFOOD","TENNIND","J&KBANK","BRIGADE","TATAINVEST","TATATECH","CPPLUS","CEATLTD","SUNDARMFIN",
        "CHENNPETRO","ESCORTS","SCHNEIDER","ABREL","ICICIPRULI","SHYAMMETL","AARTIIND","LALPATHLAB","GMDCLTD","GRANULES","SAGILITY","MRPL","WELSPUNLIV","SAREGAMA","STARHEALTH","CEMPRO","ABSLAMC","HEG","TORNTPOWER","BATAINDIA",
        "ITCHOTELS","MMTC","CREDITACC","SYNGENE","APTUS","SIGNATURE","COROMANDEL","FLUOROCHEM","BAJAJHLDNG","JSL","KARURVYSYA","TECHNOE","JBMA","DEEPAKFERT","BAJAJHFL","FIRSTCRY","KEC","ARE&M","ABBOTINDIA","BEML",
        "ASAHIINDIA","PARADEEP","BERGEPAINT","CHAMBLFERT","BHARTIHEXA","IRCTC","LTFOODS","GICRE","ECLERX","JBCHEPHARM","AFFLE","MEDANTA","SCHAEFFLER","CASTROLIND","KPIL","ASTERDM","IGIL","NCC","FINCABLES","WHIRLPOOL",
        "TIMKEN","GLAXO","USHAMART","CENTRALBK","IPCALAB","ABFRL","HEXT","FIVESTAR","AIAENG","ZYDUSWELL","NTPCGREEN","CRAFTSMAN","ELGIEQUIP","ACC","BLS","ACE","JKCEMENT","ANURAS","URBANCO","GPIL",
        "ELECON","BALKRISIND","CYIENT","NEWGEN","AFCONS","CONCORDBIO","JMFINANCIL","LATENTVIEW","IRCON","ONESOURCE","EIDPARRY","TRIDENT","CLEAN","RITES","PVRINOX","POLYMED","LTTS","CAPLIPOINT","HONAUT","GRAVITA",
        "KIMS","CARBORUNIV","BLUESTARCO","RKFORGE","VTL","NSLNISP","SONATSOFTW","MAPMYINDIA","AIIL","CESC","MGL","INDIAMART","CHOLAHLDNG","ANTHEM","SWANCORP","BALRAMCHIN","IRB","PTCIL","UCOBANK","GILLETTE",
        "CCL","RAILTEL","THELEELA","DEEPAKNTR","GODREJIND","ZENSARTECH","DOMS","FSL","SARDAEN","DEVYANI","IKS","FACT","INTELLECT","SUMICHEM","CHALET","AAVAS","TBOTEK","ITI","SJVN","AJANTPHARM",
        "BAYERCROP","LINDEINDIA","NIVABUPA","AEGISVOPAK","ATUL","JSWDULUX","UTIAMC","ABLBL","RAINBOW","SAPPHIRE","CRISIL","CANFINHOME","NUVOCO","NAVA","SBFC","JUBLPHARMA","ABDL","SOBHA","IOB","TTML",
        "JUBLINGREA","RHIM","PFIZER","BIKAJI","BLUEDART","SUNTV","CIEINDIA","TEGA","UBL","INDGN","CANHLIFE","3MINDIA","BBTC","ERIS","SPLPETRO","TRAVELFOOD","GODIGIT","EIHOTEL","GALLANTT","DCMSHRIRAM",
    ]
}
...
SECTOR_ALIASES = {
    ...
    "AUTOMOBILE": "AUTO", "AUTOMOBILES": "AUTO", "AUTOMOTIVE": "AUTO", "EV": "EV",
    "OIL": "ENERGY", "OIL AND GAS": "ENERGY",
